  ...
  return (
    <div>
      ...
      <div className="container mx-auto mt-5 px-4">
        ...
        {/* Tarifs et Forfaits */}
        <section className="mb-8">
          <h2 className="text-3xl font-semibold mb-4">Tarifs </h2>
          <p className="mb-4">Nous proposons des tarifs compétitifs adaptés à vos besoins :</p>
          <table className="min-w-full bg-white">
            ...
            <tbody>
              <tr>
                ...
                <td className="border px-4 py-2">À partir de 80€</td>
              </tr>
              <tr>
